...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"mode\": () => (/* binding */ mode),\n/* harmony export */   \"displayP\": () => (/* binding */ displayP),\n/* harmony export */   \"display\": () => (/* binding */ display),\n/* harmony export */   \"buttonGrid\": () => (/* binding */ buttonGrid),\n/* harmony export */   \"numbersButton\": () => (/* binding */ numbersButton),\n/* harmony export */   \"modalContainer\": () => (/* binding */ modalContainer),\n/* harmony export */   \"modalInfo\": () => (/* binding */ modalInfo),\n/* harmony export */   \"modalInfoButton\": () => (/* binding */ modalInfoButton)\n/* harmony export */ });\n/* harmony import */ var _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Fazt/Fazt */ \"./src/Fazt/Fazt.js\");\n/* harmony import */ var _DarkMode_DarkMode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../DarkMode/DarkMode */ \"./src/DarkMode/DarkMode.js\");\n/* harmony import */ var _Calculate_CalculateAll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Calculate/CalculateAll */ \"./src/Calculate/CalculateAll.js\");\n// import './Calculator.css';\n\n\n\n\n// tempat untuk menyimpan angka dan operator\nlet numbers = [];\n\n// DOM Selection\nconst buttons = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelectorAll('.button-grid button');\nconst display = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.display');\nconst displayP = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.display p');\nconst clear = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.clear');\nconst mode = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.mode');\nconst buttonGrid = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.button-grid');\nconst numbersButton = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelectorAll('.button-grid .active');\nconst blackOverlay = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.black-overlay');\nconst modalContainer = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.modal-container');\nconst modalInfo = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.modal-container .modal-info');\nconst modalInfoButton = _Fazt_Fazt__WEBPACK_IMPORTED_MODULE_0__.$.querySelector('.modal-container .modal-info button');\n\n\n/* jika localStorage memiliki mode dark\nmaka atur tampilan menjadi dark mode */\nif(localStorage.getItem('mode') == 'dark'){\n    (0,_DarkMode_DarkMode__WEBPACK_IMPORTED_MODULE_1__.default)();\n}\n\n// jika yang di klik adalah tombol toggle dark mode\nmode.addEventListener('click', () => {\n    (0,_DarkMode_DarkMode__WEBPACK_IMPORTED_MODULE_1__.default)();\n});\n\nmodalInfoButton.addEventListener('click', (e) => {\n    e.target.parentElement.parentElement.classList.add('hidden');\n    blackOverlay.classList.add('hidden');\n});\n\n// Looping semua button untuk nantinya di select\nbuttons.forEach(button => {\n\n    // jika ada button yang di select \n    button.addEventListener('click', (e) => {\n        \n        // Jika yang diklik adalah sama dengan ( = ) maka kalkulasi\n        if(e.target.classList.contains('equals')){\n            if(numbers.length == 0){\n                blackOverlay.classList.remove('hidden');\n                modalContainer.classList.remove('hidden');\n            } else {\n                displayP.innerHTML = (0,_Calculate_CalculateAll__WEBPACK_IMPORTED_MODULE_2__.default)(numbers);\n                displayP.classList.add('hidden');\n    \n                setTimeout(() => {\n                    displayP.classList.remove('hidden');\n                }, 100);\n            }\n            \n        // tapi selain tombol = yang di klik \n        } else {\n\n            // tampilkan ke DOM\n            let number = e.target.textContent; // <- berisi angka, operator\n            displayP.textContent += number; // <- tampilkan ke DOM\n\n            // dan setor ke Array nilainya untuk di kalkulasi\n            // jika yang di klik adalah operator expression push\n            if(number === \"+\" || number === \"-\" || number === \"*\" || number === \"/\"){\n                numbers.push(number);\n            } else {\n                numbers.push(parseInt(number)); // masukkan nilai ke array menjadi tipe number\n            }\n\n        }\n    });\n})\n\n// Reset Calculator\nclear.addEventListener('click', () => {\n    numbers.length = 0;\n    displayP.innerHTML = '';\n})\n\n\n\n//# sourceURL=webpack://calculator/./src/Calculator/Calculator.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Calculator_Calculator_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Calculator/Calculator.css */ \"./src/Calculator/Calculator.css\");\n/* harmony import */ var _Calculator_Calculator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Calculator/Calculator */ \"./src/Calculator/Calculator.js\");\n\n\n\n\n//# sourceURL=webpack://calculator/./src/index.js?");
